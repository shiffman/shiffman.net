...
The thing is, as you may have noticed, I got a little side tracked.  Along the way to broadcasting, I started recording and uploading lessons.   And now I have hours and hours of them.  It's quite unclear to me how useful these are given the fact that the videos provide no tools for the viewer to ask questions or interact with the content itself.  But this fall, in addition to continuing to use the system to record lessons, I'm planning to finally experiment with some live broadcasts.   Following is a recording of a quick and dirty test using Google Hangout.  A hangout allowed us to screen share the wirecast window as one of the feeds as well as invite viewers to call in and ask questions.  Think of it as open office hours or a "call-in" programming advice show.  I'm hoping to do one more test next week and then officially begin once per week in September.
