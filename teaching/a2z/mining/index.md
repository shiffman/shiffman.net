...
<pre lang="java">String stuff = â€œNumber of apples: 62.  Boy, do I like apples or what!â€;</pre>
...
<pre lang="java">&lt;title&gt;Conditions for New York, NY at 3:51 pm EST&lt;/title&gt;</pre>
<p>and some have <strong><em>attributes</em></strong>:</p>
<pre lang="java">&lt;yweather:forecast day="Mon" date="20 Feb 2006" low="25" high="37" text="Clear" code="31"/&gt;</pre>
...
<pre lang="java">import com.yahoo.search.*;</pre>
