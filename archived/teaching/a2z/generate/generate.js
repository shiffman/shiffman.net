...
function preload() {
  json = loadJSON('letterfreq.json');
}

function setup() {

  var ngramarea = getElement('ngramarea');
  var order = getElement('order');
  var ngrambutton = getElement('ngrambutton');
  var ngramsresult = getElement('ngramsresult');
  ...
  setInterval(function() { 
   ...
   possible += ' .';
   var randomit = getElement('randomit');
   var tobe = '';
   for (var i = 0; i < 18; i++) {
  ...
  setInterval(function() { 
   var randomfreq = getElement('randomfreq');
   var tobe = '';
   for (var i = 0; i < 18; i++) {
  ...
  setInterval(function() {
    var ngramtest = getElement('ngramtest');
    var ngrams = {
      't': ['o', '_', 'o'],
      'o': ['_', 'r', 't', '_']
    };
