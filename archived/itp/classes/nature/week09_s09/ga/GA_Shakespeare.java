...
public void displayInfo() {
  ...
  text("mutation rate: " + PApplet.parseInt(mutationRate * 100) + "%",20,185);
}
...
class DNA {
  ...
  public DNA mate(DNA partner) {
    ...
    int crossover = PApplet.parseInt(random(dna.length)); // Pick a midpoint
...
class Population {
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--present", "--bgcolor=#666666", "--stop-color=#cccccc", "GA_Shakespeare" });
  }
}
