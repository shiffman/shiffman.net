import processing.core.*; import java.applet.*; import java.awt.*; import java.awt.image.*; import java.awt.event.*; import java.io.*; import java.net.*; import java.text.*; import java.util.*; import java.util.zip.*; public class WolframCA extends PApplet {// Wolfram Cellular Automata
...
class CA {
  ...
  public void randomize() {
    for (int i = 0; i < 8; i++) {
      rules[i] = PApplet.toInt(random(2));
    }
  }
...
static public void main(String args[]) {   PApplet.main(new String[] { "WolframCA" });}}