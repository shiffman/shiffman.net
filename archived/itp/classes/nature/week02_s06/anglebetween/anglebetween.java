import processing.core.*; import java.applet.*; import java.awt.*; import java.awt.image.*; import java.awt.event.*; import java.io.*; import java.net.*; import java.text.*; import java.util.*; import java.util.zip.*; public class anglebetween extends PApplet {// Simple Vector3D
...
public void draw() {
  ...
  textFont(f);
  fill(255);
  text(PApplet.toInt(degrees(theta)),10,40);
...
static public void main(String args[]) {   PApplet.main(new String[] { "anglebetween" });}}