import processing.core.*; import java.applet.*; import java.awt.*; import java.awt.image.*; import java.awt.event.*; import java.io.*; import java.net.*; import java.text.*; import java.util.*; import java.util.zip.*; public class neural1 extends PApplet {// Daniel Shiffman
...
public void setup() {
  ...
  ptron = new Perceptron(3,0.004f);  // Learning Constant is low just b/c it's fun to watch, this is not optimal
...
static public void main(String args[]) {   PApplet.main(new String[] { "neural1" });}}